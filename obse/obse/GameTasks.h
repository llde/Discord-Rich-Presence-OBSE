...
class QueuedDistantLOD : public QueuedModel
{
public:
	QueuedDistantLOD();
	~QueuedDistantLOD();
...
class DistantLODLoaderTask : public QueuedFileEntry
{
public:
	DistantLODLoaderTask();
	~DistantLODLoaderTask();
...
public:
	...
	LockFreeMap<ModelKF *>							* kfMap;		// 04 LockFreeCaseInsensitiveStringMap<kfModel>
